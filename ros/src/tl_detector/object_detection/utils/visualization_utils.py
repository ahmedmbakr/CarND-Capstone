...
# Bakr: I created this function to be similar to visualize_boxes_and_labels_on_image_array function but not to draw boxes on the image
def get_boxes_and_classes_on_image_array(
    image,
    boxes,
    classes,
    scores,
  ...
  box_to_class_map = collections.defaultdict(int)
  ...
  return image,box_to_class_map.items()
